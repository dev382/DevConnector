...
- From the dashboard route, users have the ability to either edit their profile, add any developer experience, and add their educational background.

- From the posts route, users can create new posts and delete them if necessary. From this route they can also join the discussion within the posts created by other users, as well as like or unlike specific posts.

- From the profiles route, users are able to view the profiles of all the registered members and click on them to view more specific details of a particular profile.
...
---
>>>>>>> d920ffdb9a9e88df295e307bec06647f891eb13c
